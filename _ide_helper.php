 ...
 * Generated for Laravel 5.8.35 on 2019-09-20 13:54:36.
 *
...
namespace App\Facades {
    ...
    class APIReturnFacade {
         ...
         * @static
         */
        public static function success($data = array(), $msg = 'success', $httpCode = 200, $redirect = null)
        {
                        /** @var \App\Services\APIReturnService $instance */
                        return $instance->success($data, $msg, $httpCode, $redirect);
        }
         ...
         * @static
         */
        public static function fail($msg = 'fail', $data = array(), $httpCode = 500, $redirect = null)
        {
                        /** @var \App\Services\APIReturnService $instance */
                        return $instance->fail($msg, $data, $httpCode, $redirect);
        }
...
namespace  {
    ...
    class APIReturn extends \App\Facades\APIReturnFacade {
        public static function error(\Illuminate\Support\MessageBag $errors)
        {
        }
    }
